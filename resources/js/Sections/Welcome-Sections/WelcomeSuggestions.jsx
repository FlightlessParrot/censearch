...
export default function WelcomeSuggestions(props) {
    ...
    return (
        <div className="w-full h-full">
            ...
            <div className="flex flex-wrap overflow-x-hidden custom-scrollbar gap-3 mr-10 md:gap-6 max-h-40 md:max-h-80 ">
                {jsxOtherSearches}
            </div>
            <h3 className="text-xl m-8">Może zainteresuje Cię</h3>
            <div className="flex flex-wrap scroll gap-2 max-h-40 overflow-x-hidden mr-10 custom-scrollbar ">
                {jsxSuggestions}
            </div>
        </div>
    );
