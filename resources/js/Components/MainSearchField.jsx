...
export default function MainSearchField(props)
{
    ...
    return(
        ...
        <form className=" flex flex-col md:flex-row items-center  gap-8">
            <input  value={props.data.search} onChange={(e)=>props.setData({'search': e.target.value})} type='text' className="max-w-md flex-grow flex-shrink h-10 border-sel border  bg-dark-sel focus:border-white focus:ring-0  focus:!outline-none">
            </input>
