...
use App\Http\Controllers\DisplayTopArticle;
...
Route::get('/top/{topId}', DisplayTopArticle::class)->name('Article');
...
Route::post('/login', [UserController::class, 'authenticate'])->middleware(['throttle:login'])->name('login');
